...
from categories.models import PeripheralCategory
...
class Peripheral(models.Model):
    ...
    category = models.ForeignKey(PeripheralCategory, on_delete=models.SET_NULL, null=True, related_name='peripherals')
...
class PeripheralSpec(models.Model):
    peripheral = models.OneToOneField(Peripheral, on_delete=models.CASCADE, related_name='specs')
    ...
    class Meta:
        db_table = 'peripheral_specs'

    def __str__(self):
        return f"Specs for {self.peripheral.name}"
