...
from categories.models import ComponentCategory
...
class Component(models.Model):
    ...
    category = models.ForeignKey(ComponentCategory, on_delete=models.SET_NULL, null=True, related_name='components')
...
class ComponentSpec(models.Model):
    component = models.OneToOneField(Component, on_delete=models.CASCADE, related_name='specs')
