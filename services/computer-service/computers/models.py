...
from categories.models import ComputerCategory
...
class Computer(models.Model):
    ...
    category = models.ForeignKey(ComputerCategory, on_delete=models.SET_NULL, null=True, related_name='computers')
...
class ComputerSpec(models.Model):
    computer = models.OneToOneField(Computer, on_delete=models.CASCADE, related_name='specs')
    ...
    def __str__(self):
        return f"Specs for {self.computer.name}"
