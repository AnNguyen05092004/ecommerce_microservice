...
from categories.models import MonitorCategory
...
class Monitor(models.Model):
    ...
    category = models.ForeignKey(MonitorCategory, on_delete=models.SET_NULL, null=True, related_name='monitors')
...
class MonitorSpec(models.Model):
    monitor = models.OneToOneField(Monitor, on_delete=models.CASCADE, related_name='specs')
    ...
    def __str__(self):
        return f"Specs for {self.monitor.name}"
