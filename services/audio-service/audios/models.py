...
from categories.models import AudioCategory
...
class Audio(models.Model):
    ...
    category = models.ForeignKey(AudioCategory, on_delete=models.SET_NULL, null=True, related_name='audios')
...
class AudioSpec(models.Model):
    audio = models.OneToOneField(Audio, on_delete=models.CASCADE, related_name='specs')
    ...
    class Meta:
        db_table = 'audio_specs'

    def __str__(self):
        return f"Specs for {self.audio.name}"
