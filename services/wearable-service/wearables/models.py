...
from categories.models import WearableCategory
...
class Wearable(models.Model):
    ...
    category = models.ForeignKey(WearableCategory, on_delete=models.SET_NULL, null=True, related_name='wearables')
...
class WearableSpec(models.Model):
    wearable = models.OneToOneField(Wearable, on_delete=models.CASCADE, related_name='specs')
    ...
    def __str__(self):
        return f"Specs for {self.wearable.name}"
